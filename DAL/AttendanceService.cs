...
namespace DAL
{
    public class AttendanceService
    {
        ...
        public string GetAllStudents()
        {
            ...
            {
                return "暂时无法获取到已签到的学员总数" + ex.Message;
            }
        ...
        /// <returns></returns>
        public List<StudentExt> GetStudentByDate(DateTime beginDate, DateTime endDate, string name)
        {
            string sql = "select StudentId,StudentName,Gender,ClassName,DTime,Attendance.CardNo from Students";
